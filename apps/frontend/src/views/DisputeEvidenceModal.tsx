			...
			<div className="bg-white border border-[#E4E4E7] max-w-lg w-full p-6 shadow-lg rounded">
				<div className="mb-4">
					...
					<p className="text-xs text-[#71717A] mt-1 leading-relaxed">
						Provide a written statement and optional attachments. The arbiter
						will review this folder before deciding the split.
					</p>
				</div>
					...
					<div>
						...
						>
							...
							<span className="text-xs font-medium text-black block">
								{file
									? file.name
									: "Click or Drag & Drop to upload evidence file"}
							</span>
