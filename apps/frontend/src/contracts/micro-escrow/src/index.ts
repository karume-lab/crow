...
import type { i128, Option, u32 } from "@stellar/stellar-sdk/contract";
import {
...
// Removed wildcard exports of stellar-sdk to fix Vite interop warnings
...
export const networks = {
	standalone: {
		...
		contractId: "CBQJUSH6M3624HJHGBIRVQCMUJX7JSDZISHRE36YU4UDSE6JLY4UZUMZ",
	},
} as const;
...
export interface Client {
	...
	) => Promise<AssembledTransaction<Option<Escrow>>>;
	 ...
	 */
	resolve_dispute: (
		{ escrow_id, freelancer_share }: { escrow_id: u32; freelancer_share: i128 },
		options?: MethodOptions,
	) => Promise<AssembledTransaction<null>>;
...
export class Client extends ContractClient {
	...
	constructor(public readonly options: ContractClientOptions) {
		super(
			new ContractSpec([
				"AAAAAQAAAAAAAAAAAAAABkVzY3JvdwAAAAAABwAAAAAAAAAGYW1vdW50AAAAAAALAAAAAAAAAAdhcmJpdGVyAAAAABMAAAAAAAAABmNsaWVudAAAAAAAEwAAAAAAAAAKZnJlZWxhbmNlcgAAAAAAEwAAAAAAAAACaWQAAAAAAAQAAAAAAAAABnN0YXR1cwAAAAAH0AAAAAxFc2Nyb3dTdGF0dXMAAAAAAAAABXRva2VuAAAAAAAAEw==",
